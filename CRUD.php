...
');
    ...
    function edit_user($firstName, $lastname, $address, $city, $zip, $country, $email) {
        global $dbh;
        ...
        $this->sth = $dbh->prepare('UPDATE `Php_Project`.`user_Detail`
SET
firstName=:firstName,
lastname=:lastname,
adress=:address,
...
WHERE userId=:userId;');
    ...
    function account_value($user_Id) {
        ...
        $this->sth = $dbh->prepare('INSERT INTO `Php_Project`.`user_Status`
	(
	userId	
	)
